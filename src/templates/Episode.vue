  ...
  metaInfo() {
    return {
      ...
      meta:[
        ...
        {name: 'twitter:image:alt', content: `Enjoy the Vue #${this.$page.episode.episode_number}`},
        ...
        {property: 'og:image:alt', content: `Enjoy the Vue #${this.$page.episode.episode_number}`},
