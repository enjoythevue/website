...
shownotes: >+
  ...
  How Pine has expanded Vetur’s functionality beyond autocomplete and diagnostic
  errors.

  The beginnings of Vetur: Pine’s love of Vue which wasn’t compatible with VS
  Code.

  How Pine developed early Vetur versions by copy-pasting and modifying parts of
  existing support from other platforms.
  ...
  The line between learning and building; recent projects Pine did and what they
  taught him.
  ...
  “Other than learning to innovate on new ideas, I also want to learn to be able
  to see certain things that people of other disciplines can’t. That’s one of
  the reasons I am learning to draw with color.” — @octref [0:33:13]
